...
public class TPAtlasHelper
{
    ...
    public static void MakePolyAtlas(Object obj, bool isCompress, bool isSplitChannel, string algorithm = "Polygon")
    {
        ...
        try
        {
            ...
            TPAtlasPacker.MakeAtlas_Polygon(name, srcPath, PATH_TP_TEMP, algorithm);
